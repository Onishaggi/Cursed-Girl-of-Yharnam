...
public class AggressorStatesPackageManager:IAggressorStateHandler
{
    private AggressorStatesPackage _statesPackage;
    ...
    public AggressorStatesPackageManager(AggressorStatesPackage _statesPackage)
    {
    ...
    public List<IAggressorState> States { get { return _statesPackage.States; } set { _statesPackage.States = value; } }
    ...
    public IAggressorState GetCurrentState(Transform self, Transform target)
    {
